                    ...
                    <div class="col-md-9" id="basket">
                        ...
                        <div class="box">
                            ...
                            <form method="post" action="checkout1.html">
                                ...
                                <h1>Shopping cart</h1>
                                <p class="text-muted">You currently have 3 item(s) in your cart ${Items.size()}.</p>
                                    ...
                                    <table  id="cartItemTable" class="table">
                                        ...
                                        <tbody>
                                            <c:forEach items="${Items}" var="order">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" value="${order.quantity}" min="1" max="${order.orderProduct.availableQuantity}" class="form-control">
                                                    </td>
                                                    <td>${order.orderProduct.productPrice}</td>
                                                    <td>$0.00</td>
                                                    <td>${order.orderProduct.productPrice*order.quantity}</td>
                                                    <c:set var="totalprice" value="${totalprice+(order.orderProduct.productPrice*order.quantity)}"/>

                                                    <td><i class="fa fa-trash-o myItem" onclick="deleteRow(this)"></i>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th colspan="2"><c:out value = "${totalprice}"/></th>
                                            </tr>
                                        </tfoot>
                                    </table>
