                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="password" pattern=".{8,}" value="${requestScope.currentCustomer.custPassword}" required="true"  oninvalid="setCustomValidity('Must be at least 8 characters!')" oninput="setCustomValidity('')" disabled="true">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="email">Confirm password</label>
                                            <input type="password" class="form-control" name="confirmPassword" pattern=".{8,}" value="${requestScope.currentCustomer.custPassword}" required="true" oninvalid="setCustomValidity('Must be at least 8 characters!')" oninput="setCustomValidity('')" disabled="true">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form method="POST" action="userProfile">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="street">Address</label>
                                            <input type="text" class="form-control" name="address" value="${requestScope.currentCustomer.custAddress}" required="true" disabled="true">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.row -->
...
>>>>>>> 8d692b32aec97a6f2f2d1fa4ce3d5f3ce4a4902c
